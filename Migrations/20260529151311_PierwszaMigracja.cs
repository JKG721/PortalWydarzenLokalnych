...
namespace PortalWydarzenLokalnych.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZdjecieSciezka = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaksUczestnikow = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wydarzenia_Kategorie_KategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Zapisy_AspNetUsers_UzytkownikId",
                        column: x => x.UzytkownikId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Zapisy_Wydarzenia_WydarzenieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wydarzenia_KategoriaId",
                table: "Wydarzenia",
                column: "KategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_Zapisy_UzytkownikId",
                table: "Zapisy",
                column: "UzytkownikId");

            migrationBuilder.CreateIndex(
                name: "IX_Zapisy_WydarzenieId",
                table: "Zapisy",
                column: "WydarzenieId");
        }
